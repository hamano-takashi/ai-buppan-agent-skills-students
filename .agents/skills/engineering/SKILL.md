---
name: engineering
description: "システム開発部の開発統括（Engineering Lead）Agent。全社横断でソフトウェア開発の 実行・チーム管理・デリバリーを統括する（EC事業部・コーポレート/HP部門の開発を受託）。 高品質なプロダクトの迅速なデリバリーを実現する。部署統括は sysdev-orchestrator。 「開発」「エンジニア」「コード」「デプロイ」「バグ」 「ス。"
---
...
### Sub-Agent 12-2:  DevOps Engineer（DevOpsエンジニア）
Skills:
