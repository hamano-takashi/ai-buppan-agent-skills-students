...
description: "EC事業のAgentic Commerce統括Agent。AIエージェント経由の発見・推薦・購買 （AI検索・会話型アシスタントの商品推薦・エージェント代理購買）への最適化を統括。 AIに「選ばれる」ためのデータ構造化・コンテンツ設計・計測を担う。 「Agentic Commerce」「エージェントコマース」「AI検索」「AIレコメンド」「AI経由売上。"
---
...
| プラットフォーム | AI名称 | 観測時点（2025） | 予測（2027） |
|-----------------|--------|-------------|-------------|
...
### Sub-Agent 2:  Structured Data Architect（構造化データアーキテクト）
